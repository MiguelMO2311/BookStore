...
const AddBook: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-start pt-5 border-dashed">
      <div className="w-2/3 shadow-md rounded px-8 pt-6 pb-8 mb-4 hover:bg-white">
        <h1 className="text-2xl font-bold m-3 text-slate-800 hover:text-yellow-300">Añadir Libro</h1>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button 
  className="bg-slate-500 hover:bg-slate-800 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline ml-[55%] sm:py-2 sm:px-4" type="submit"> Añadir Libro
            </button>
          </div>
        </form>
      </div>
