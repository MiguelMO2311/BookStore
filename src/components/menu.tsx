        ...
        <div className={className}>
            <nav className={`flex ${isOpen ? 'flex-col' : ''} justify-start items-center px-4 text-xl`}>
                <div className={`flex ${isOpen ? 'flex-col' : ''} justify-start`}>
                    <a className="ml-8 text-blue-700 hover:text-blue-400" href="/HomePage" onClick={() => setIsOpen(false)}>Home</a>
                    <a className="ml-8 text-red-700 hover:text-red-400" href="/BooksPage" onClick={() => setIsOpen(false)}>Books</a>
                </div>
